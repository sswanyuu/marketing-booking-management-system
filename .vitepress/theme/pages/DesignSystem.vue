  ...
  <div class="py-5">
      ...
      <div class="col-8">
        <div class="bs-component mb-3">
          <template v-for="themeColor of themeColors">
            <button type="button" class="btn" :class="`btn-${themeColor}`">
              {{ themeColor }}
            </button>
          </template>
      ...
      <div class="col-4">
        ...
        <div class="bs-component">
          <p>
            ...
            elit. Nihil veritatis voluptas! Adipisci cum, incidunt nostrum
            quidem repellat sed velit. Architecto ipsum itaque reprehenderit!
            Aliquam aut culpa ipsam
          </p>
          <p>
            <small>
      ...
      <div class="col-6 bs-component">
        ...
        <div id="nav-tabContent" class="tab-content">
          <div
            ...
            tabindex="0"
          >
            HOMERaw denim you probably haven't heard of them jean shorts Austin.
          ...
          <div
            ...
            tabindex="0"
          >
            PROFILEFood truck fixie locavore, accusamus mcsweeney's marfa nulla
    ...
    <div class="badges row" style="margin-bottom: 40px">
      <div class="col-6 bs-component">
        ...
        <template v-for="themeColor of themeColors">
          <span class="badge" :class="`text-bg-${themeColor}`">
            {{ themeColor }}
          </span>
        </template>
      </div>
    ...
    <div class="badges row">
      <div class="col-6 bs-component">
        <template v-for="themeColor of themeColors">
          <span class="badge rounded-pill" :class="`text-bg-${themeColor}`">
            {{ themeColor }}
          </span>
        </template>
      </div>
    ...
    <div class="cards row">
      <div class="col-4 bs-component">
        <template v-for="themeColor of themeColors">
          <div
            class="card text-bg-{{themeColor}} mb-3"
      ...
      <div class="col-4 bs-component">
        <div class="card" style="width: 18rem">
          ...
          <img
            ...
            class="card-img-top"
            alt="Image"
            style="background-color: gray; min-height: 200px"
          />
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">
